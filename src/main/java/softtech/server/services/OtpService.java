	...
	private String buildFallbackOtpContent(String otp) {
		return """
			<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
				<h2 style="color: #2c3e50; text-align: center;">🎬 Cinema Management System</h2>
				<h3 style="color: #34495e; text-align: center;">OTP Verification Code</h3>
				
				<p>Hello,</p>
				<p>You have requested an OTP code for verification. Please use the code below:</p>
				
				<div style="text-align: center; margin: 20px 0;">
					<span style="font-size: 28px; font-weight: bold; color: #e74c3c; background-color: #f8f9fa; padding: 15px 25px; border-radius: 8px; letter-spacing: 3px;">
						""" + otp + """
					</span>
				</div>
				...
				<p style="text-align: center; color: #7f8c8d; font-size: 14px;">
					Best regards,<br>Cinema Management Team<br>
